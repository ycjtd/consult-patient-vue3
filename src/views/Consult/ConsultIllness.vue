...
onMounted(() => {
  if (store.consult.illnessDesc) {
    showConfirmDialog({
      ...
      // 回显数据
      const { illnessDesc, illnessTime, pictures, consultFlag } = store.consult
      form.value = { illnessDesc, illnessTime, pictures, consultFlag }
...
<template>
  <div class="consult-illness-page">
    ...
    <div class="illness-form">
      ...
      <!-- 下一步按钮 -->
      <van-button type="primary" round block :class="{ disabled }" @click="next"
        >下一步</van-button
      >
    </div>
  </div>
